...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("TELE_WALI_FRIENDSHIP")
                await self.one.join_chat("THE_THIRD_EYE_NETWORK")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("TELE_WALI_FRIENDSHIP")
                await self.two.join_chat("THE_THIRD_EYE_NETWORK")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("TELE_WALI_FRIENDSHIP")
                await self.three.join_chat("THE_THIRD_EYE_NETWORK")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("TELE_WALI_FRIENDSHIP")
                await self.four.join_chat("THE_THIRD_EYE_NETWORK")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("TELE_WALI_FRIENDSHIP")
                await self.five.join_chat("THE_THIRD_EYE_NETWORK")
            except:
                pass
            assistants.append(5)
